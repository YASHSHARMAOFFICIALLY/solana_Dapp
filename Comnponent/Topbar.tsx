...
function TopBar(){
    ...
    return(
        <div className='sticky top-0 z-50 border-b backdrop-blur-xl border-white/20 bg-white/40'>
            <div className='max-w-5xl flex items-center mx-auto justify-between px-6 h-14'>
